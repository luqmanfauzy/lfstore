    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="mb-14 max-w-xl mx-auto">
                <form action="{{ route('category-product', ['slug' => request()->route('slug')]) }}" method="GET" class="flex items-center">
                    <input type="text" name="query" value="{{ request('query') }}" placeholder="Cari produk {{ $categoryName }}..."
            ...
            <div class="flex justify-center items-center mb-8">
                <h2 class="text-3xl font-semibold">Kategory : {{ $categoryName }}</h2>
            </div>
                    ...
                    <a href="{{ route('detail', $data->slug) }}">
                        <div
                            ...
                            <div class="p-3 flex-grow flex flex-col justify-between">
                                <div>
                                    <p class="font-semibold text-md md:text-lg line-clamp-3 md:line-clamb-4"
                                        title="{{ $data->name }}">
                                        {{ $data->name }}
                                    </p>
                                </div>
